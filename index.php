    ...
    <main>
        <div class="video-banner">
            <div style="padding:42.19% 0 0 0;position:relative;">
                <iframe
                    src="https://player.vimeo.com/video/861833688?h=cb0f8ccbf6&autoplay=1&muted=1&loop=1&title=0&byline=0&portrait=0&controls=0"
        ...
        <section class="full-row homepage-video-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 ">
                        <img src="<?php echo $base_url ?>/img/Paitson bros Terre Haute (2).jpeg" alt=""
                            style="width:100%;">
                    </div>
                </div>
            </div>
